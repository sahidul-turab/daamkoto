"""
Skyland SSD scraper — OpenCart structure.

Usage:
  python scrapers/skyland/scrape_ssd.py           # print only
  python scrapers/skyland/scrape_ssd.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_ssd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland SSD listings")
