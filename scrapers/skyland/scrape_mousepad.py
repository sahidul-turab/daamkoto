"""Skyland Mousepad scraper — URL: /accessories/mouse-pad
...
START_URL = f"{BASE_URL}/accessories/mouse-pad"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_mousepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland mousepad listings")
