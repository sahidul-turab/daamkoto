"""
Skyland Portable SSD scraper — OpenCart structure.

Usage:
  python scrapers/skyland/scrape_portable_ssd.py           # print only
  python scrapers/skyland/scrape_portable_ssd.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_portable_ssd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland Portable SSD listings")
