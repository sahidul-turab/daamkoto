"""Skyland Webcam scraper — URL: /accessories/webcam
...
START_URL = f"{BASE_URL}/accessories/webcam"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_webcam_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland webcam listings")
