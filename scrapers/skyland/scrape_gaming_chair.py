"""Skyland Gaming Chair scraper — URL: /gaming/gaming-chair
...
START_URL = f"{BASE_URL}/gaming/gaming-chair"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_gaming_chair_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland gaming_chair listings")
