"""Skyland Printer scraper — URL: /office-equipment/printer
...
START_URL = f"{BASE_URL}/office-equipment/printer"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_printer_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland printer listings")
