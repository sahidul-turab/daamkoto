"""Skyland Keyboard scraper — URL: /accessories/keyboard
...
START_URL = f"{BASE_URL}/accessories/keyboard"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_keyboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland keyboard listings")
