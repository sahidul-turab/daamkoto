"""Skyland Monitor scraper — URL: /monitor/monitor-and-displays
...
START_URL = f"{BASE_URL}/monitor/monitor-and-displays"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_monitor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland monitor listings")
