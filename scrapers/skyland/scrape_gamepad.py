"""Skyland Gamepad scraper — URL: /gaming/gamepad
...
START_URL = f"{BASE_URL}/gaming/gamepad"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_gamepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland gamepad listings")
