"""
Skyland Motherboard scraper — OpenCart structure.

Usage:
  python scrapers/skyland/scrape_motherboard.py           # print only
  python scrapers/skyland/scrape_motherboard.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_motherboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland Motherboard listings")
