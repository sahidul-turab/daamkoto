"""Skyland Mouse scraper — URL: /accessories/mouse
...
START_URL = f"{BASE_URL}/accessories/mouse"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland mouse listings")
