"""Skyland Headset scraper — URL: /sound-system/headphone
...
START_URL = f"{BASE_URL}/sound-system/headphone"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_headset_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland headset listings")
