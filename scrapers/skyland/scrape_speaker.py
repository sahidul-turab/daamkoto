"""Skyland Speaker scraper — URL: /sound-system/speaker-and-home-theater
Skyland PSU scraper — OpenCart structure.

Usage:
  python scrapers/skyland/scrape_psu.py           # print only
  python scrapers/skyland/scrape_psu.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/sound-system/speaker-and-home-theater"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_speaker_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland speaker listings")
