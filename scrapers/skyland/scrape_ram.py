"""
Skyland BD RAM scraper — OpenCart structure, same as UltraTech.

Usage:
  python scrapers/skyland/scrape_ram.py           # print only
  python scrapers/skyland/scrape_ram.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_ram_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland BD RAM listings")
