"""
Skyland BD GPU scraper — OpenCart structure, same as UltraTech.

Usage:
  python scrapers/skyland/scrape_gpu.py           # print only
  python scrapers/skyland/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"skyland_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Skyland BD GPU listings")
