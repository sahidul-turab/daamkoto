"""
Potaka IT Processor scraper — same structure as scrape_gpu.py, different URL.

Usage:
  python scrapers/potakait/scrape_processor.py           # print only
  python scrapers/potakait/scrape_processor.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/processors"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"potakait_processor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Potaka IT Processor listings")
