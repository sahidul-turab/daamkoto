"""
Potaka IT GPU scraper — same structure as scrape_ram.py, different URL.

Usage:
  python scrapers/potakait/scrape_gpu.py           # print only
  python scrapers/potakait/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/graphics-cards"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"potakait_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Potaka IT GPU listings")
