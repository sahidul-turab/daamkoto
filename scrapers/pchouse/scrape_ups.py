"""Pchouse Ups scraper — URL: /offline-ups
...
START_URL = f"{BASE_URL}/offline-ups"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"pchouse_ups_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape PC House BD ups listings")
