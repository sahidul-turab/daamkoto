"""Techland Portable HDD scraper — click-based SPA pagination. URL: /storage/portable-hdd"""
...
START_URL = f"{BASE_URL}/storage/portable-hdd"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_portable_hdd_{ts}.json"
