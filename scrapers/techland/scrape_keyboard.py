"""Techland Keyboard scraper — URL: /accessories/computer-keyboard"""
...
START_URL = f"{BASE_URL}/accessories/computer-keyboard"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_keyboard_{ts}.json"
