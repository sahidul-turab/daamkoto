"""Techland CPU Cooler scraper — click-based SPA pagination. URL: /pc-components/cpu-cooler"""
...
START_URL = f"{BASE_URL}/pc-components/cpu-cooler"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_cooler_{ts}.json"
