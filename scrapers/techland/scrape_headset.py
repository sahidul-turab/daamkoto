"""Techland Headset scraper — URL: /accessories/headphone-speaker/shop-headphones-headsets"""
...
START_URL = f"{BASE_URL}/accessories/headphone-speaker/shop-headphones-headsets"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_headset_{ts}.json"
