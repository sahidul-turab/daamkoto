"""Techland Portable SSD scraper — click-based SPA pagination. URL: /storage/portable-ssd"""
...
START_URL = f"{BASE_URL}/storage/portable-ssd"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_portable_ssd_{ts}.json"
