"""Techland SSD scraper — click-based SPA pagination. URL: /pc-components/solid-state-drive"""
...
START_URL = f"{BASE_URL}/pc-components/solid-state-drive"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_ssd_{ts}.json"
