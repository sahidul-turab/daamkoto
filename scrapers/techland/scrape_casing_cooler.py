"""Techland Casing Cooler (case fans) scraper — click-based SPA pagination. URL: /pc-components/casing-fan"""
...
START_URL = f"{BASE_URL}/pc-components/casing-fan"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_casing_cooler_{ts}.json"
