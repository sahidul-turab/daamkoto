"""Techland Monitor scraper — URL: /monitor-and-display/computer-monitor"""
...
START_URL = f"{BASE_URL}/monitor-and-display/computer-monitor"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_monitor_{ts}.json"
