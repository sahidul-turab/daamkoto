"""Techland HDD scraper — click-based SPA pagination. URL: /pc-components/hard-disk-drive"""
...
START_URL = f"{BASE_URL}/pc-components/hard-disk-drive"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_hdd_{ts}.json"
