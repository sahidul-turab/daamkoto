"""Techland Mouse scraper — URL: /accessories/shop-computer-mouse"""
...
START_URL = f"{BASE_URL}/accessories/shop-computer-mouse"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_mouse_{ts}.json"
