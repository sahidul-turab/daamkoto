"""Techland Speaker scraper — URL: /tv-home-entertainment/multimedia-speakers"""
...
START_URL = f"{BASE_URL}/tv-home-entertainment/multimedia-speakers"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_speaker_{ts}.json"
