"""Techland PSU scraper — click-based SPA pagination. URL: /pc-components/power-supply"""
...
START_URL = f"{BASE_URL}/pc-components/power-supply"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_psu_{ts}.json"
