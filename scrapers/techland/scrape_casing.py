"""Techland Casing scraper — click-based SPA pagination. URL: /pc-components/casing"""
...
START_URL = f"{BASE_URL}/pc-components/casing"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"techland_casing_{ts}.json"
