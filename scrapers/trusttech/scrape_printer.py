"""Trusttech Printer scraper — URL: /categories/printer
...
START_URL = f"{BASE_URL}/categories/printer"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_printer_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD printer listings")
