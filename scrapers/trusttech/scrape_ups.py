"""Trusttech Ups scraper — URL: /categories/ups
...
START_URL = f"{BASE_URL}/categories/ups"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_ups_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD ups listings")
