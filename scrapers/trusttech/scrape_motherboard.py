"""
Trust Tech BD Motherboard scraper — Vue-based storefront.

Usage:
  python scrapers/trusttech/scrape_motherboard.py           # print only
  python scrapers/trusttech/scrape_motherboard.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/categories/motherboard"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_motherboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD Motherboard listings")
