"""
Trust Tech BD Processor scraper — Vue-based storefront.

Usage:
  python scrapers/trusttech/scrape_processor.py           # print only
  python scrapers/trusttech/scrape_processor.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/categories/processor"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_processor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD Processor listings")
