"""
Trust Tech BD CPU Cooler scraper — Vue-based storefront.

Usage:
  python scrapers/trusttech/scrape_cooler.py           # print only
  python scrapers/trusttech/scrape_cooler.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/categories/cpu-cooler"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD CPU Cooler listings")
