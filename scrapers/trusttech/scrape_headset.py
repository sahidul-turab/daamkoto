"""Trusttech Headset scraper — URL: /categories/headphone
...
START_URL = f"{BASE_URL}/categories/headphone"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_headset_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD headset listings")
