"""Casing Cooler scraper for TrustTech — URL: /categories/case-fan"""
...
START_URL = f"{BASE_URL}/categories/case-fan"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_casing_cooler_{ts}.json"
