"""Trusttech Gaming Chair scraper — URL: /categories/gaming-chair
Trust Tech BD PSU scraper — Vue-based storefront.

Usage:
  python scrapers/trusttech/scrape_psu.py           # print only
  python scrapers/trusttech/scrape_psu.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/categories/gaming-chair"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_gaming_chair_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD gaming_chair listings")
