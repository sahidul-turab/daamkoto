"""Trusttech Mouse scraper — URL: /categories/mouse
...
START_URL = f"{BASE_URL}/categories/mouse"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Trust Tech BD mouse listings")
