"""Portable SSD scraper for TrustTech — URL: /categories/portable-ssd"""
...
START_URL = f"{BASE_URL}/categories/portable-ssd"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"trusttech_portable_ssd_{ts}.json"
