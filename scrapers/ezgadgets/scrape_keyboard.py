"""
EZ Gadgets Keyboard scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_keyboard.py           # print only
  python scrapers/ezgadgets/scrape_keyboard.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_keyboard.py --dom     # force the fallback
"""
...
ARCHIVE_URL   = f"{BASE_URL}/product-category/peripherals/keyboard/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_keyboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Keyboard listings")
