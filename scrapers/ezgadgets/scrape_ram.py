"""
EZ Gadgets RAM Desktop scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_ram.py           # print only
  python scrapers/ezgadgets/scrape_ram.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_ram.py --dom     # force the fallback
"""
...
CATEGORY_SLUG = "ram"
ARCHIVE_URL   = f"{BASE_URL}/product-category/pc-components/ram/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_ram_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets RAM Desktop listings")
