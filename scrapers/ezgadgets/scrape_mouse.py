"""
EZ Gadgets Mouse scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_mouse.py           # print only
  python scrapers/ezgadgets/scrape_mouse.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_mouse.py --dom     # force the fallback
"""
...
CATEGORY_SLUG = "gaming-mouse"
ARCHIVE_URL   = f"{BASE_URL}/product-category/peripherals/gaming-mouse/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Mouse listings")
