"""
EZ Gadgets Motherboard scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_motherboard.py           # print only
  python scrapers/ezgadgets/scrape_motherboard.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_motherboard.py --dom     # force the fallback
"""
...
ARCHIVE_URL   = f"{BASE_URL}/product-category/pc-components/motherboard/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_motherboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Motherboard listings")
