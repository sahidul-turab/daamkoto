"""
EZ Gadgets GPU scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_gpu.py           # print only
  python scrapers/ezgadgets/scrape_gpu.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_gpu.py --dom     # force the fallback
"""
...
ARCHIVE_URL   = f"{BASE_URL}/product-category/pc-components/graphics-card/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets GPU listings")
