"""
EZ Gadgets Mouse Pad scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_mousepad.py           # print only
  python scrapers/ezgadgets/scrape_mousepad.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_mousepad.py --dom     # force the fallback
"""
...
CATEGORY_SLUG = "mousepad"
ARCHIVE_URL   = f"{BASE_URL}/product-category/mousepad/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_mousepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Mouse Pad listings")
