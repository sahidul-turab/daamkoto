"""
EZ Gadgets Gamepad scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_gamepad.py           # print only
  python scrapers/ezgadgets/scrape_gamepad.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_gamepad.py --dom     # force the fallback
"""
...
ARCHIVE_URL   = f"{BASE_URL}/product-category/gamepad/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_gamepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Gamepad listings")
