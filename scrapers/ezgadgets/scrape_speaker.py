"""
EZ Gadgets Speaker scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_speaker.py           # print only
  python scrapers/ezgadgets/scrape_speaker.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_speaker.py --dom     # force the fallback
"""
...
ARCHIVE_URL   = f"{BASE_URL}/product-category/peripherals/speaker/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_speaker_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets Speaker listings")
