"""
EZ Gadgets CPU Cooler scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_cooler.py           # print only
  python scrapers/ezgadgets/scrape_cooler.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_cooler.py --dom     # force the fallback
"""
...
CATEGORY_SLUG = "cpu-coller"
ARCHIVE_URL   = f"{BASE_URL}/product-category/cpu-coller/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets CPU Cooler listings")
