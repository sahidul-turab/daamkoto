"""
EZ Gadgets SSD scraper — WooCommerce Store API, with a DOM fallback.
...
Usage:
  python scrapers/ezgadgets/scrape_ssd.py           # print only
  python scrapers/ezgadgets/scrape_ssd.py --save    # save JSON to data/raw/
  python scrapers/ezgadgets/scrape_ssd.py --dom     # force the fallback
"""
...
CATEGORY_SLUG = "ssd"
ARCHIVE_URL   = f"{BASE_URL}/product-category/pc-components/storage-pc-components/ssd/"
...
async def main(save: bool = False, force_dom: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ezgadgets_ssd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape EZ Gadgets SSD listings")
