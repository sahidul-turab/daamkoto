"""Ryans Portable SSD scraper — CF bypass, fresh context per page."""
...
CATEGORY_URL = f"{BASE_URL}/category/storage-external-ssd"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_portable_ssd_{ts}.json"
