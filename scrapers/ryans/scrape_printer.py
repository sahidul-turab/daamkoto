"""Ryans Printer scraper — URL: /category/document-printer-laser-printer"""
...
CATEGORY_URL = f"{BASE_URL}/category/document-printer-laser-printer"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_printer_{ts}.json"
