"""Ryans Mousepad scraper — URL: /category/desktop-component-mouse-pad"""
...
CATEGORY_URL = f"{BASE_URL}/category/desktop-component-mouse-pad"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_mousepad_{ts}.json"
