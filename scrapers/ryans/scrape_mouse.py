"""Ryans Mouse scraper — URL: /category/desktop-component-mouse"""
...
CATEGORY_URL = f"{BASE_URL}/category/desktop-component-mouse"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_mouse_{ts}.json"
