"""Ryans Gaming Chair scraper — URL: /category/gaming-component-gaming-chair"""
...
CATEGORY_URL = f"{BASE_URL}/category/gaming-component-gaming-chair"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_gaming_chair_{ts}.json"
