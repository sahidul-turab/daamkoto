"""Ryans Motherboard scraper — CF bypass, fresh context per page."""
...
CATEGORY_URL = f"{BASE_URL}/category/desktop-component-motherboard"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_motherboard_{ts}.json"
