"""
Ryans Portable HDD scraper
URL: https://www.ryans.com/category/storage-portable-hdd

Uses fresh context per page to bypass Cloudflare JS challenge.

Usage:
  python scrapers/ryans/scrape_portable_hdd.py           # print only
  python scrapers/ryans/scrape_portable_hdd.py --save    # print + save JSON to data/raw/
"""
...
CATEGORY_URL = f"{BASE_URL}/category/external-hdd"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save and all_products:
        ...
        out_path = out_dir / f"ryans_portable_hdd_{timestamp}.json"
