"""Ryans Keyboard scraper — URL: /category/desktop-component-keyboard"""
...
CATEGORY_URL = f"{BASE_URL}/category/desktop-component-keyboard"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_keyboard_{ts}.json"
