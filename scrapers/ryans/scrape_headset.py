"""Ryans Headset scraper — URL: /category/audio-video-headphone"""
...
CATEGORY_URL = f"{BASE_URL}/category/audio-video-headphone"
PAGE_DELAY   = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ryans_headset_{ts}.json"
