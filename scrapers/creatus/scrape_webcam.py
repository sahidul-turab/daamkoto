"""Creatus Webcam scraper — URL: /webcam
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_webcam_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus webcam listings")
