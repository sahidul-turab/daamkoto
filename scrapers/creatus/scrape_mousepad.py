"""Creatus Mousepad scraper — URL: /mouse-pad
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_mousepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus mousepad listings")
