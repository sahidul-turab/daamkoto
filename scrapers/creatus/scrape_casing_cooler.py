"""
Creatus Casing Cooler scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_casing_cooler.py           # print only
  python scrapers/creatus/scrape_casing_cooler.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_casing_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus Casing Cooler listings")
