"""
Creatus Motherboard scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_motherboard.py           # print only
  python scrapers/creatus/scrape_motherboard.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_motherboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus Motherboard listings")
