"""
Creatus Portable HDD scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_portable_hdd.py           # print only
  python scrapers/creatus/scrape_portable_hdd.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_portable_hdd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus Portable HDD listings")
