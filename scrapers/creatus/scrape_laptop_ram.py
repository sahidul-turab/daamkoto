"""
Creatus Laptop RAM scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_laptop_ram.py           # print only
  python scrapers/creatus/scrape_laptop_ram.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_laptop_ram_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus Laptop RAM listings")
