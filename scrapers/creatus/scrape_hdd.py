"""
Creatus HDD scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_hdd.py           # print only
  python scrapers/creatus/scrape_hdd.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/hard-disk"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_hdd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus HDD listings")
