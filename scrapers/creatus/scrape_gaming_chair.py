"""Creatus Gaming Chair scraper — URL: /gaming-chair
Creatus PSU scraper — OpenCart structure.

Usage:
  python scrapers/creatus/scrape_psu.py           # print only
  python scrapers/creatus/scrape_psu.py --save    # save JSON to data/raw/
"""
...
BASE_URL  = "https://www.creatus.com.bd"
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_gaming_chair_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus gaming_chair listings")
