"""Creatus Keyboard scraper — URL: /keyboard
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_keyboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus keyboard listings")
