"""Creatus Gamepad scraper — URL: /gamepad
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_gamepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus gamepad listings")
