"""Creatus Printer scraper — URL: /printer
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_printer_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus printer listings")
