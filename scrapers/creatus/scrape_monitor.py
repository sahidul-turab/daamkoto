"""Creatus Monitor scraper — URL: /monitor
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"creatus_monitor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Creatus monitor listings")
