"""Selltech Monitor scraper — URL: /Monitor
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_monitor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD monitor listings")
