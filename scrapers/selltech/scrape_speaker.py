"""Selltech Speaker scraper — URL: /Bluetooth-Speakers
Sell Tech BD GPU scraper — OpenCart structure.
No desktop RAM category available on this site.

Usage:
  python scrapers/selltech/scrape_gpu.py           # print only
  python scrapers/selltech/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/Bluetooth-Speakers"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_speaker_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD speaker listings")
