"""Selltech Headset scraper — URL: /Headphone
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_headset_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD headset listings")
