"""Selltech Mouse scraper — URL: /Mouse
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD mouse listings")
