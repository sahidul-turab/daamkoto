"""Selltech Ups scraper — URL: /offline-ups
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_ups_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD ups listings")
