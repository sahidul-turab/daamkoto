"""Selltech Webcam scraper — URL: /Webcam
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_webcam_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD webcam listings")
