"""Selltech Printer scraper — URL: /Printer
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"selltech_printer_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Sell Tech BD printer listings")
