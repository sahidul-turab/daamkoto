"""
Ultra Technology BD GPU scraper — same structure as scrape_ram.py, different URL.

Usage:
  python scrapers/ultratech/scrape_gpu.py           # print only
  python scrapers/ultratech/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ultratech_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Ultra Technology GPU listings")
