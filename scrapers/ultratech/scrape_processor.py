"""
Ultra Technology BD Processor scraper — same structure as scrape_gpu.py, different URL.

Usage:
  python scrapers/ultratech/scrape_processor.py           # print only
  python scrapers/ultratech/scrape_processor.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"ultratech_processor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Ultra Technology Processor listings")
