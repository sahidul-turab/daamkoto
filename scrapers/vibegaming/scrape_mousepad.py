"""VibeGaming Mouse Pad scraper — WooCommerce.

Listing: /product-category/mouse/mouse-pad/
...
Usage:
  python scrapers/vibegaming/scrape_mousepad.py           # print only
  python scrapers/vibegaming/scrape_mousepad.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/mouse/mouse-pad/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_mousepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming mousepad listings")
