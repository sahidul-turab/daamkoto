"""VibeGaming Speaker scraper — WooCommerce.

Listing: /product-category/speakers/
...
Usage:
  python scrapers/vibegaming/scrape_speaker.py           # print only
  python scrapers/vibegaming/scrape_speaker.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/speakers/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_speaker_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming speaker listings")
