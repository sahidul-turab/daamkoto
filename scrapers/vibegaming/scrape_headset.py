"""VibeGaming Headset scraper — WooCommerce.

Listing: /product-category/headphones/
...
Usage:
  python scrapers/vibegaming/scrape_headset.py           # print only
  python scrapers/vibegaming/scrape_headset.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/headphones/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_headset_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming headset listings")
