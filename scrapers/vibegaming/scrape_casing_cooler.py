"""VibeGaming Casing Cooler scraper — WooCommerce.

Listings (2, de-duplicated by the shop's product id):
  · /product-category/component/cooling-fans/
  · /product-category/component/case-fan/
...
Usage:
  python scrapers/vibegaming/scrape_casing_cooler.py           # print only
  python scrapers/vibegaming/scrape_casing_cooler.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/cooling-fans/",
    f"{BASE_URL}/product-category/component/case-fan/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_casing_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming casing_cooler listings")
