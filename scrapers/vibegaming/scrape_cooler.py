"""VibeGaming CPU Cooler scraper — WooCommerce.

Listing: /product-category/cpu-cooler/
...
Usage:
  python scrapers/vibegaming/scrape_cooler.py           # print only
  python scrapers/vibegaming/scrape_cooler.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/cpu-cooler/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming cooler listings")
