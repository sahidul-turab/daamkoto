"""VibeGaming Mouse scraper — WooCommerce.

Listings (4, de-duplicated by the shop's product id):
  · /product-category/mouse/wireless-mouse/
  · /product-category/mouse/wired-mouse/
  · /product-category/mouse/gaming-mouse/
  · /product-category/mouse/professional-mouse/
...
Usage:
  python scrapers/vibegaming/scrape_mouse.py           # print only
  python scrapers/vibegaming/scrape_mouse.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/mouse/wireless-mouse/",
    f"{BASE_URL}/product-category/mouse/wired-mouse/",
    f"{BASE_URL}/product-category/mouse/gaming-mouse/",
    f"{BASE_URL}/product-category/mouse/professional-mouse/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming mouse listings")
