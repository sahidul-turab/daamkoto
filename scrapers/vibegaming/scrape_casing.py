"""VibeGaming Casing scraper — WooCommerce.

Listing: /product-category/component/casing/
...
Usage:
  python scrapers/vibegaming/scrape_casing.py           # print only
  python scrapers/vibegaming/scrape_casing.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/casing/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_casing_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming casing listings")
