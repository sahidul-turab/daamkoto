"""VibeGaming HDD scraper — WooCommerce.

Listing: /product-category/component/hard-disk-drive/
...
Usage:
  python scrapers/vibegaming/scrape_hdd.py           # print only
  python scrapers/vibegaming/scrape_hdd.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/hard-disk-drive/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_hdd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming hdd listings")
