"""VibeGaming PSU scraper — WooCommerce.

Listing: /product-category/component/power-supply/
...
Usage:
  python scrapers/vibegaming/scrape_psu.py           # print only
  python scrapers/vibegaming/scrape_psu.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/power-supply/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_psu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming psu listings")
