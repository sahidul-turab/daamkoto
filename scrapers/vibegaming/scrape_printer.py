"""VibeGaming Printer scraper — WooCommerce.

Listing: /product-category/office-equipment/printer/
...
Usage:
  python scrapers/vibegaming/scrape_printer.py           # print only
  python scrapers/vibegaming/scrape_printer.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/office-equipment/printer/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_printer_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming printer listings")
