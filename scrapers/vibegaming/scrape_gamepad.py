"""VibeGaming Gamepad scraper — WooCommerce.

Listings (2, de-duplicated by the shop's product id):
  · /product-category/gaming-peripherals/gamepad/
  · /product-category/general-categorygamepad/
...
Usage:
  python scrapers/vibegaming/scrape_gamepad.py           # print only
  python scrapers/vibegaming/scrape_gamepad.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/gaming-peripherals/gamepad/",
    f"{BASE_URL}/product-category/general-categorygamepad/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_gamepad_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming gamepad listings")
