"""VibeGaming Gaming Chair scraper — WooCommerce.

Listings (2, de-duplicated by the shop's product id):
  · /product-category/gaming-peripherals/gaming-chair/
  · /product-category/gaming-chair-2/
...
Usage:
  python scrapers/vibegaming/scrape_gaming_chair.py           # print only
  python scrapers/vibegaming/scrape_gaming_chair.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/gaming-peripherals/gaming-chair/",
    f"{BASE_URL}/product-category/gaming-chair-2/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_gaming_chair_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming gaming_chair listings")
