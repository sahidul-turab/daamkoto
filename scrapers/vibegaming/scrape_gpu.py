"""VibeGaming GPU scraper — WooCommerce.

Listing: /product-category/component/graphics-card/
...
Usage:
  python scrapers/vibegaming/scrape_gpu.py           # print only
  python scrapers/vibegaming/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/graphics-card/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming gpu listings")
