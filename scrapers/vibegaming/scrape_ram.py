"""VibeGaming RAM Desktop scraper — WooCommerce.

Listing: /product-category/component/ram/
...
Usage:
  python scrapers/vibegaming/scrape_ram.py           # print only
  python scrapers/vibegaming/scrape_ram.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/ram/",
]
PAGE_DELAY = 2.5
...
EXCLUDE_NAME = re.compile(r"\b(ssd|nvme|solid[\s-]state[\s-]drive)\b", re.I)
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_ram_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming ram listings")
