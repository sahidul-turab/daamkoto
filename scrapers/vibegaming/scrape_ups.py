"""VibeGaming UPS scraper — WooCommerce.

Listing: /product-category/component/offline-ups/
...
Usage:
  python scrapers/vibegaming/scrape_ups.py           # print only
  python scrapers/vibegaming/scrape_ups.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/offline-ups/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_ups_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming ups listings")
