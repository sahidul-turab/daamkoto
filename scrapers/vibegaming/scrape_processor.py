"""VibeGaming Processor scraper — WooCommerce.

Listing: /product-category/component/processor/
...
Usage:
  python scrapers/vibegaming/scrape_processor.py           # print only
  python scrapers/vibegaming/scrape_processor.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/processor/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_processor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming processor listings")
