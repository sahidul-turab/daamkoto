"""VibeGaming Monitor scraper — WooCommerce.

Listing: /product-category/monitors/
...
Usage:
  python scrapers/vibegaming/scrape_monitor.py           # print only
  python scrapers/vibegaming/scrape_monitor.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/monitors/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_monitor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming monitor listings")
