"""VibeGaming Keyboard scraper — WooCommerce.

Listings (5, de-duplicated by the shop's product id):
  · /product-category/keyboards/mechanical-keyboards/
  · /product-category/keyboards/wired-keyboard/
  · /product-category/keyboards/gaming-keyboards/
  · /product-category/keyboards/wireless-keyboard/
  · /product-category/keyboards/magnetic-keyboard/
...
Usage:
  python scrapers/vibegaming/scrape_keyboard.py           # print only
  python scrapers/vibegaming/scrape_keyboard.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/keyboards/mechanical-keyboards/",
    f"{BASE_URL}/product-category/keyboards/wired-keyboard/",
    f"{BASE_URL}/product-category/keyboards/gaming-keyboards/",
    f"{BASE_URL}/product-category/keyboards/wireless-keyboard/",
    f"{BASE_URL}/product-category/keyboards/magnetic-keyboard/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_keyboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming keyboard listings")
