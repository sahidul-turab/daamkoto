"""VibeGaming SSD scraper — WooCommerce.

Listing: /product-category/component/ssd/
...
Usage:
  python scrapers/vibegaming/scrape_ssd.py           # print only
  python scrapers/vibegaming/scrape_ssd.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/component/ssd/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_ssd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming ssd listings")
