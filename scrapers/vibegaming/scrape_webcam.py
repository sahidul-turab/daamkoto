"""VibeGaming Webcam scraper — WooCommerce.

Listing: /product-category/webcam/
...
Usage:
  python scrapers/vibegaming/scrape_webcam.py           # print only
  python scrapers/vibegaming/scrape_webcam.py --save    # save JSON to data/raw/
"""
...
START_URLS = [
    f"{BASE_URL}/product-category/webcam/",
]
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"vibegaming_webcam_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape VibeGaming webcam listings")
