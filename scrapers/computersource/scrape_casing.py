"""
Computer Source BD Casing scraper — custom CMS.

Card: .product  |  Name: h4.name a  |  Price: .price-wrap .price-new

Usage:
  python scrapers/computersource/scrape_casing.py           # print only
  python scrapers/computersource/scrape_casing.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_casing_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD Casing listings")
