"""
Computer Source BD Processor scraper — custom CMS.

Card: .product  |  Name: h4.name a  |  Price: .price-wrap .price-new

Usage:
  python scrapers/computersource/scrape_processor.py           # print only
  python scrapers/computersource/scrape_processor.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/processor"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_processor_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD Processor listings")
