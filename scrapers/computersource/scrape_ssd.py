"""
Computer Source BD SSD scraper — custom CMS.

Card: .product  |  Name: h4.name a  |  Price: .price-wrap .price-new

Usage:
  python scrapers/computersource/scrape_ssd.py           # print only
  python scrapers/computersource/scrape_ssd.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_ssd_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD SSD listings")
