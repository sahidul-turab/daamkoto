"""
Computer Source BD RAM scraper — custom CMS.
...
Usage:
  python scrapers/computersource/scrape_ram.py           # print only
  python scrapers/computersource/scrape_ram.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_ram_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD RAM listings")
