"""
Computer Source BD GPU scraper — custom CMS.

Card: .product
Name: h4.name a
Price: .price-wrap .price-new  (format: ৳15,500)
Stock: price presence (no explicit stock element)
Pagination: ?page=N

Usage:
  python scrapers/computersource/scrape_gpu.py           # print only
  python scrapers/computersource/scrape_gpu.py --save    # save JSON to data/raw/
"""
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_gpu_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD GPU listings")
