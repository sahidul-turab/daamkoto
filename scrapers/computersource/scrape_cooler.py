"""
Computer Source BD CPU Cooler scraper — custom CMS.

Card: .product  |  Name: h4.name a  |  Price: .price-wrap .price-new

Usage:
  python scrapers/computersource/scrape_cooler.py           # print only
  python scrapers/computersource/scrape_cooler.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/cpu-cooler"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_cooler_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD CPU Cooler listings")
