"""Computersource Mouse scraper — URL: /mouse
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"computersource_mouse_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape Computer Source BD mouse listings")
