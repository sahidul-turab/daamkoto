"""
StarTech Motherboard scraper — same structure as scrape_gpu.py, different URL.

Usage:
  python scrapers/startech/scrape_motherboard.py           # print only
  python scrapers/startech/scrape_motherboard.py --save    # save JSON to data/raw/
"""
...
START_URL = f"{BASE_URL}/component/motherboard"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"startech_motherboard_{timestamp}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Scrape StarTech Motherboard listings")
