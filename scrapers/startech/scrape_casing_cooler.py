"""StarTech Casing Cooler (case fans) scraper — URL: /component/casing-cooler"""
...
START_URL = f"{BASE_URL}/component/casing-cooler"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"startech_casing_cooler_{ts}.json"
