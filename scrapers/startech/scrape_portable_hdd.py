"""StarTech Portable HDD scraper — URL: /component/portable-hard-disk-drive"""
...
START_URL = f"{BASE_URL}/component/portable-hard-disk-drive"
PAGE_DELAY = 2.5
...
async def main(save: bool = False):
    ...
    if save:
        ...
        out_path = out_dir / f"startech_portable_hdd_{ts}.json"
